...
<div class="row">
    @php
        $stats = [
            ['label' => 'Total Classes', 'count' => $total_classes, 'icon' => 'icon-home', 'accent' => 'border-left-primary bg-soft-primary text-primary'],
            ['label' => 'Total Subjects', 'count' => $total_subjects, 'icon' => 'icon-book', 'accent' => 'border-left-success bg-soft-success text-success'],
            ['label' => 'Total Students', 'count' => $total_students, 'icon' => 'icon-users', 'accent' => 'border-left-warning bg-soft-warning text-warning'],
            ['label' => 'Total Exams', 'count' => $total_exams, 'icon' => 'icon-file-text2', 'accent' => 'border-left-danger bg-soft-danger text-danger'],
        ];
    @endphp
...
<div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center text-muted">No recent exams</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    <div class="col-lg-4">
         <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('classes.index') }}" class="btn btn-primary btn-block mb-3">
                    <i class="icon-home mr-2"></i> Manage Classes
                </a>
                <a href="{{ route('subjects.index') }}" class="btn btn-success btn-block mb-3">
                    <i class="icon-book mr-2"></i> Manage Subjects
                </a>
                <a href="{{ route('exams.index') }}" class="btn btn-info btn-block mb-3">
                    <i class="icon-file-text2 mr-2"></i> Manage Exams
                </a>
            </div>
        </div>
    </div>
