...
<div class="row">
    @php
        $stats = [
            ['label' => 'Total Logs', 'count' => $total_logs, 'icon' => 'icon-list', 'accent' => 'border-left-primary bg-soft-primary text-primary'],
            ['label' => 'Recent Logs (7d)', 'count' => $recent_logs_count, 'icon' => 'icon-history', 'accent' => 'border-left-success bg-soft-success text-success'],
            ['label' => 'Total Payments', 'count' => Qs::formatCurrency($total_payments), 'icon' => 'icon-cash3', 'accent' => 'border-left-warning bg-soft-warning text-warning'],
            ['label' => 'Total Expenses', 'count' => Qs::formatCurrency($total_expenses), 'icon' => 'icon-cart-add', 'accent' => 'border-left-danger bg-soft-danger text-danger'],
        ];
    @endphp
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted">No recent activity logs</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
