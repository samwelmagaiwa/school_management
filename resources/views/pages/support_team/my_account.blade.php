                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form enctype="multipart/form-data" method="post" action="{{ route('my_account.update') }}">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label font-weight-semibold">Current Photo</label>
                                        <div class="col-lg-9">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ $my->photo }}" alt="Current photo" class="rounded-circle mr-3" style="width: 64px; height: 64px;">
                                                <div class="text-muted small">This is the picture that is shown across the dashboard.</div>
                                            </div>
                                        </div>
                                    </div>
